...
当截止线进一步向右移动时，给决策者更好的机会做出正确的决定，相应的点向下移动ROC曲线向更低的命中率。这说明了潜在决策问题中命中率和误报率之间的基本交易关系。对于任何给定的问题，决策算法或分类器将存在于虚警/命中率空间中的某些ROC曲线上。提高命中率通常以增加更多错误警报的可能性为代价。
...
最终的数字可能会忽略重要信息，我们将抵制停在那里的诱惑。例如，一个非常大的负月回报导致轻微的负偏差吗？如果是这样，发生了什么？或者它是由几个中等负面回报引起的？是什么造成的？他们是连续的吗？它们是季节性的吗 我们需要进一步调查。
...
滚动图表非常有启发性，表明六个月的间隔偏差在该投资组合的大约一半的时间内是正的。今天，整体偏度是负面的，但2016年中期的滚动偏度为正，大于1.从2016年底开始大幅下挫，2017年3月最低读数为-1.65，极有可能造成当市场担心美国大选时，会产生一两个非常大的负回报。我们可以看到，随着2017年的滚动偏度变得更加积极，这些担忧开始减轻。
